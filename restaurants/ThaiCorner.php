...
<head>
    ...
    <title>ReadyBelly | Thai Corner</title>
...
<style>
header {
    background: url(../img/rest/ThaiCorner/cover.jpg);
...
<div class="top-border">
        ...
        <div class="top-logo">
            <div class="wrapper">
                <h1><a href="ThaiCorner.php">Thai Corner</a></h1>
            </div>
        </div>
        ...
        <div class="nav-left-sidebar sidebar-dark fixed-top">
            <ul class="navbar-nav flex-column">
                ...
                <a class="nav-link active" href="GrandBeijing.php">Grand Beijing</a>
                    ...
                    <a id="active-side" class="nav-link active" href="ThaiCorner.php">Thai Corner</a>
                </li>
        </div>
        </div>
        <div class="col-lg-10">
