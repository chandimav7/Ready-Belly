...
<head>
    ...
    <title>ReadyBelly | Raja Bojun</title>
...
<style>
header {
    background: url(../img/rest/RajaBojun/Srilankanfoods.jpg);
...
<div class="top-border">
        ...
        <div class="top-logo">
            <div class="wrapper">
                <h1><a href="RajaBojun.php">Raja Bojun</a></h1>
            </div>
        </div>
        ...
        <div class="nav-left-sidebar sidebar-dark fixed-top">
            <ul class="navbar-nav flex-column">
                ...
                <a class="nav-link active" href="GrandBeijing.php">Grand Beijing</a>
                    ...
                    <a id="active-side" class="nav-link active" href="RajaBojun.php">Raja Bojun</a>
