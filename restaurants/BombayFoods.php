...
<head>
    ...
    <title>ReadyBelly | Bombay Foods</title>
...
<style>
header {
    background: url(../img/rest/BombayFoods/Cover.png);
...
<div class="top-border">
        ...
        <div class="top-logo">
            <div class="wrapper">
                <h1><a href="BombayFoods.php">Bombay Foods</a></h1>
            </div>
        </div>
    ...
    <div class="mid-section">
        ...
        <div class="nav-left-sidebar sidebar-dark fixed-top">
            <ul class="navbar-nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="GrandBeijing.php">Grand Beijing</a>
                    <a id="active-side" class="nav-link active" href="BombayFoods.php">Bombay Foods</a>
